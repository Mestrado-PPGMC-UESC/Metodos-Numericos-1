 ...
 * compara com uma solução exata lida de outro arquivo.
 */
int main(void) {
    // ============================================
    ...
    // Gauss (sem pivotamento ou conforme sua implementação),
    // com tolerância para pivô ~ 0
    ...
    if (status == GAUSS_INCONSISTENTE) {
        ...
        // Imprime solução obtida (mesmo que instável)
